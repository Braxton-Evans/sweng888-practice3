...
public class Share_ProductAdapter extends RecyclerView.Adapter<Share_ProductAdapter.ViewHolder> {
    private List<Product> products;
    public Share_ProductAdapter(List<Product> products) { this.products = products; }

    @Override
    public ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.share_product_recycler_item, parent, false);
